...
const CheckIcon = () => (
  ...
  >
    <svg xmlns="http://www.w3.org/2000/svg" width="12" height="9" viewBox="0 0 12 9" fill="none">
      <path d="M11.7502 0.251116C12.085 0.585938 12.085 1.12969 11.7502 1.46451L4.89308 8.32165C4.55826 8.65647 4.01451 8.65647 3.67969 8.32165L0.251116 4.89308C-0.0837054 4.55826 -0.0837054 4.01451 0
    </svg>
  </div>
)
...
const FireIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
    <path d="M11.7734 7.46667C11.62 7.26667 11.4334 7.09333 11.26 6.92C10.8134 6.52 10.3067 6.23333 9.88003 5.81333C8.8867 4.84 8.6667 3.23333 9.30003 2C8.6667 2.15333 8.11337 2.5 7.64003 2.88C5.91337
  </svg>
)
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '24px', textAlign: 'center' }}>
        ...
        >
          <div style={{ width: '8px', height: '8px', borderRadius: '9999px', background: '#EA580C' }} />
          <span style={{ color: '#52525B', fontFamily: 'Inter', fontSize: '12px', fontWeight: 500, lineHeight: '20px' }}>
            PRICING
          </span>
        </div>
      ...
      <div
        ...
        style={{ maxWidth: '800px', alignItems: 'stretch', gap: '24px' }}
      >
        {/* Starter Card — NO overflow: hidden anymore */}
        <div
          style={{
            display: 'flex',
            flex: '1 0 0',
        ...
        >
          ...
          >
            <span style={{ color: '#18181B', fontFamily: 'Inter', fontSize: '18px', fontWeight: 600 }}>
              Starter
            </span>
          </div>
        ...
        {/* Builder Card — NO overflow: hidden anymore */}
        <div
          style={{
            display: 'flex',
            flex: '1 0 0',
        ...
        >
          ...
          >
            <span style={{ color: '#FFFFFF', fontFamily: 'Inter', fontSize: '18px', fontWeight: 600 }}>
              Builder
            </span>
            <div
              style={{
