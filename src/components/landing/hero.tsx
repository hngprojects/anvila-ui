...
import { CAREER_CHIPS, FEATURES } from "@/data/landing/hero";
      ...
      <div className="relative mx-auto flex w-full max-w-[960px] flex-col items-center px-6 py-12 md:py-16">
        ...
        >
          ...
          <button
            ...
            className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-full border-none transition-all ${
              canSubmit
                ? "cursor-pointer bg-teal-brand text-white hover:bg-teal-brand/80"
                : "cursor-not-allowed bg-surface-muted text-copy-muted"
            }`}
          >
            <ArrowUpIcon />
          </button>
