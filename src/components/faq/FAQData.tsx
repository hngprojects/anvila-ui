    ...
    faqs: [
      {
        ...
        answer:
          "Anvila helps users scaffold reusable AI agent setup packages from a plain-language description. It generates structured Markdown files that define an agent's identity, tone, behavior, working rhythm, and matched Skills.",
      },
      {
