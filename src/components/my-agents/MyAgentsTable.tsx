    ...
    <>
      <div className="w-full overflow-x-auto pb-8">
        <div className="min-w-[960px]">
          <div className="grid grid-cols-[1.5fr_1.5fr_1.2fr_1fr_minmax(140px,1.5fr)_minmax(220px,2fr)] gap-4 px-5 py-3 text-xs font-medium text-gray-500 uppercase tracking-wide">
          ...
          <div className="space-y-3 mt-2">
            {filteredAgents.map((agent) => (
              <div
                key={agent.id}
                className="grid grid-cols-[1.5fr_1.5fr_1.2fr_1fr_minmax(140px,1.5fr)_minmax(220px,2fr)] gap-4 px-5 py-4 items-center bg-[#F8F9F9] rounded-xl text-sm"
              >
                ...
                <div>
                  <span
                    className={`inline-flex items-center justify-center px-2.5 py-1 rounded-full text-xs font-medium ${agent.visibility === "Public"
