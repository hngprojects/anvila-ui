  ...
  return (
    <div className="w-full overflow-x-auto pb-8">
      <div className="min-w-[800px]">
        {/* Table Header */}
        <div className="grid grid-cols-7 gap-4 px-5 py-3 text-xs font-medium text-gray-500 uppercase tracking-wide">
        ...
        <div className="space-y-3 mt-2">
          {filteredAgents.map((agent) => (
            <div
              key={agent.id}
              className="grid grid-cols-7 gap-4 px-5 py-4 items-center bg-[#F8F9F9] rounded-xl text-sm"
            >
              {/* Agent Name */}
              ...
              <div className="flex justify-between items-center w-full col-span-1">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  <button className="px-3 py-1 rounded-full border border-red-200 text-xs font-medium text-red-500 hover:bg-red-50 transition-colors bg-white/50">
                    Delete
                  </button>
                </div>
              </div>
