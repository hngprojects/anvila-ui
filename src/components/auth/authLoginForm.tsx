...
export const AuthLoginForm = () => {
  ...
  <path d="M17.122 15C17.2995 15 17.4728 15.0174 17.6401 15.0506C17.2325 15.7745 17 16.6101 17 17.5C17 18.3683 17.2213 19.1848 17.6106 19.8964C17.4524 19.9258 17.2891 19.9413 17.122 19.9413C15.7076 19
  <path d="M15.4473 28.986C14.8794 28.3071 14.5 27.474 14.5 26.5C14.5 25.5558 14.8566 24.744 15.3958 24.0767C13.4911 24.2245 12 25.2662 12 26.5294C12 27.8044 13.5173 28.8538 15.4473 28.986Z" fill="#F6
  <path d="M26.9999 17.5C26.9999 18.3683 26.7786 19.1848 26.3893 19.8964C26.5475 19.9258 26.7108 19.9413 26.8779 19.9413C28.2923 19.9413 29.4389 18.8351 29.4389 17.4706C29.4389 16.1061 28.2923 15 26.8
  <path d="M28.5526 28.986C30.4826 28.8538 31.9999 27.8044 31.9999 26.5294C31.9999 25.2662 30.5088 24.2245 28.6041 24.0767C29.1433 24.744 29.4999 25.5558 29.4999 26.5C29.4999 27.474 29.1205 28.3071 28
</svg>
    </div>
